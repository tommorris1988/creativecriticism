...
<div class="container-fluid entry first">
	...
	<div class="row-fluid outer" id="container">
		...
		<div class="span3 info">
			...
			<ul class="links">
				<h5 class="sub-head">Share This Story</h5>
				<li><a href="http://www.facebook.com/sharer/sharer.php?<?php the_permalink(); ?>">Facebook</a></li>
				<li><a href="https://twitter.com/share?url=<?php the_permalink(); ?>">Twitter</a></li>
			</ul>
